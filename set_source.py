...
def generate_toml(src):
    link_source = ''
    diancun = 'filecoin-proofs-api = {package = "filecoin-proofs-api", git = "https://github.com/diancun/rust-filecoin-proofs-api.git", branch = "api_v6.1.0" }'
    qiniu = 'filecoin-proofs-api = {package = "filecoin-proofs-api", git = "https://github.com/diancun/rust-filecoin-proofs-api.git", branch = "qn_610_100" }'
